 ...
 */
INI_CONFIG *
ini_config_create_from_string(char *str, int slen, int isGBK);
 ...
 */
INI_CONFIG *
ini_config_create_from_file(const char *filename, int isGBK);
 ...
 */
void
ini_config_destroy(INI_CONFIG *config);
/**
 * 获取配置整数值
 * @param config 配置对象指针
 ...
 */
int
ini_config_get_int(INI_CONFIG *config, const char *section, const char *key, int default_int);
 ...
 */
char *
ini_config_get_string(INI_CONFIG *config, const char *section, const char *key, char *default_string);
/**
 * 设置变量
 * @param config 配置对象指针
 * @param section　段名,没有段名时可以为NULL
 ...
 */
int
ini_config_set_string(INI_CONFIG *config, const char *section, const char *key, int key_len, const char *value, int value_len);
/**
 * 设置变量
 * @param config 配置对象指针
 * @param section　段名,没有段名时可以为NULL
 ...
 */
int
ini_config_set_int(INI_CONFIG *config, const char *section, const char *key, int key_len, int value);
/**
 ...
 */
int
ini_config_save(INI_CONFIG *config, const char *filename);
/**
 ...
 */
int
ini_config_print(INI_CONFIG *config, FILE *fp);
